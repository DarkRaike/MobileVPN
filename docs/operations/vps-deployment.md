...
| Не было шаблона Xray config и генерации X25519/shortId                                                                                                                                                                           | REALITY inbound `VLESS TCP REALITY` не существовал, VPN не выдавался                                    |
...
| `xray_config.json`       | inbound `VLESS TCP REALITY` с приватным ключом и short ID                                                                                       |
