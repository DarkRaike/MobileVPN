...
| Не было шаблона Xray config и генерации X25519/shortId                                                                                                                                                                           | REALITY inbound `VLESS WS` не существовал, VPN не выдавался                                             |
...
| `xray_config.json`       | inbound `VLESS WS` с приватным ключом и short ID                                                                                                |
